...
wget https://www.dropbox.com/s/qa00al2j17ogkkz/SSHWEB-PRO.zip > /dev/null 2>&1
apt-get install unzip > /dev/null 2>&1
unzip SSHWEB-PRO.zip > /dev/null 2>&1
chmod -R 777 /var/www/html
rm SSHWEB-PRO.zip index.html > /dev/null 2>&1
...
function pconf { 
sed "s/Couty123456/$pwdroot/" /var/www/html/pages/system/pass.php > /tmp/pass
mv /tmp/pass /var/www/html/pages/system/pass.php

}
function inst_db { 
cd || exit
wget https://raw.githubusercontent.com/CoutySSH/PWEB2022/main/gestorssh/sshplus.sql > /dev/null 2>&1
sleep 1
if [[ -e "$HOME/sshplus.sql" ]]; then
    mysql -h localhost -u sshplus -p"$pwdroot" --default_character_set utf8 sshplus < sshplus.sql
    rm /root/sshplus.sql
else
    clear
...
echo ""
echo -e "                 \033[1;31mBy @nCouty_SSH\033[1;36m"
echo ""
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@nCouty_SSH\033[0m"
echo ""
