...
wget -P /home https://github.com/nandoslayer/pweb/raw/painel/install/verpweb > /dev/null 2>&1
[[ -f "/home/verpweb" ]] && {
...
wget -P /home https://github.com/nandoslayer/pweb/raw/painel/install/verweb > /dev/null 2>&1
[[ -f "/home/verweb" ]] && {
